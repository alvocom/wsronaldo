...
public interface UsuarioDAO extends CrudRepository<Usuario, Integer>{
	...
	/*
	 * CrudRepository será a classe pai do UsuarioDAO e está informando ao Spring boot que esta classe armazenará o 
	 * CRUD para usuário. O Integer é para especificar que o tipo de dado da chave primária é Integer
	 */
	
	/*
	 * Métodos herdados do CrudRepository:
	 * - save (objeto): grava/alatera uma linha no BD
